/******************************************************************************/
/* GLCD.c: AVR low level Graphic LCD (320x240 pixels)                         */
/******************************************************************************/
/*                                                                            */
/******************************************************************************/
...
#define LCD_EN(x)   ((x) ? (LCD_BL_H()) : (LCD_BL_L()));
...
/* Pin CS  0 o 1                                                   */
#define LCD_CS(x)   ((x) ? (LCD_CS_H()) : (LCD_CS_L()));
/* Pin RS  0 o 1                                                   */
#define LCD_RS(x)   ((x) ? (LCD_RS_H()) : (LCD_RS_L()));
/* Pin WR  0 o 1                                                   */
#define LCD_WR(x)   ((x) ? (LCD_WR_L()) : (LCD_WR_H()));
/* Pin RD  0 o 1                                                   */
#define LCD_RD(x)   ((x) ? (LCD_RD_H()) : (LCD_RD_L()));
